...
import com.baicimi.adapter.ShareAdapter;
...
public class SharePopupWindow extends PopupWindow {
    ...
    public void showShareWindow() {
        ...
        //调用父亲变暗的方法
        changeWindowAlpha(((MainActivity) context), 0.5f);
...
//        this.setBackgroundDrawable(dw);
     ...
     * @param alpha
     */
    private static void changeWindowAlpha(MainActivity activity, float alpha) {
