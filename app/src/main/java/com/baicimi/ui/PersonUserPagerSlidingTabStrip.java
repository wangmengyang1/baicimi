 ...
 *
 */
public class PersonUserPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PersonUserPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public PersonUserPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PersonUserPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
