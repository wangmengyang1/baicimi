...
/**
 * Created by tan on 2016/12/26.
 * 可托动全局悬浮按钮自定义View
 */
public class DragFrameUi extends FrameLayout {
    private View view;
    ...
    public DragFrameUi(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
    }

    public DragFrameUi(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
    }
