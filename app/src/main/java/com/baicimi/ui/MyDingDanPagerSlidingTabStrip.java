 ...
 */
public class MyDingDanPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public MyDingDanPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public MyDingDanPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyDingDanPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
