 ...
 */
public class GrouBuyMuYiingGvAdapter extends BaseAdapter{

    private Context mContext;
    private List<GrouBuyMeiZhuangGvBean> mList;
    private LayoutInflater mLayoutInflater;

    public GrouBuyMuYiingGvAdapter(Context context, List<GrouBuyMeiZhuangGvBean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.groubuy_muying_gv_item, null);
