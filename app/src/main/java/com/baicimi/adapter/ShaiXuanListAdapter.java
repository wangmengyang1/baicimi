...
public class ShaiXuanListAdapter extends BaseAdapter{
    ...
    public ShaiXuanListAdapter(Context context, List<ShaiXuanListBean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.fragment_shaixuan_list_item, null);
            ...
            mViewHolder.shopPackage = (ImageView) convertView.findViewById(R.id.tv_baoyou);
            mViewHolder.layout = (LinearLayout) convertView.findViewById(R.id.fragment_shaixuan_list_item_layout);
