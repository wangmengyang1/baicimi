 ...
 */
public class HeadPinPaiActivityGvAdapter extends BaseAdapter{
    ...
    public HeadPinPaiActivityGvAdapter(Context context, List<ShaiXuanListBean> mList) {
    ...
    public HeadPinPaiActivityGvAdapter( Context mContext ,List<ShaiXuanListBean> mList, BaseFragment baseFragment) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mViewHolder.shopImage = (ImageView) convertView.findViewById(R.id.fragment_shaixuan_gv_item_shoping_image);
