 ...
 */
public class ManMainShowGvAdapter extends BaseAdapter{

    private Context mContext;
    private List<MuYingYongPinGridViewBean> mList;
    private LayoutInflater mLayoutInflater;

    public ManMainShowGvAdapter(Context context, List<MuYingYongPinGridViewBean> mList) {
...
//        mViewHolder.tv_goods_name.setSelected(true);
        ...
        if(position == 0){
            mViewHolder.imageUrl.setImageResource(R.mipmap.main_gridview_01);
        }else if (position == 1){
            mViewHolder.imageUrl.setImageResource(R.mipmap.main_gridview_02);
        }else if (position == 2){
            mViewHolder.imageUrl.setImageResource(R.mipmap.main_gridview_03);
        }else if (position == 3){
            mViewHolder.imageUrl.setImageResource(R.mipmap.main_gridview_01);
        }else if (position == 4){
            mViewHolder.imageUrl.setImageResource(R.mipmap.main_gridview_02);
