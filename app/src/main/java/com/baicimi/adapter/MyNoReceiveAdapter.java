 ...
 */
public class MyNoReceiveAdapter extends BaseAdapter{
    ...
    public MyNoReceiveAdapter(Context context, List<MyDingDanLvBean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final MyNoReceiveAdapter.ViewHolder mViewHolder;
        if (convertView == null) {
            mViewHolder = new MyNoReceiveAdapter.ViewHolder();
            convertView = mLayoutInflater.inflate(R.layout.fragment_my_dingdan_no_receive, null);

            mViewHolder.tv_my_dingdan_goods_message = (TextView) convertView.findViewById(R.id.my_dingdan_goods_message_noreceive);
            mViewHolder.tv_my_dingdan_goods_color = (TextView) convertView.findViewById(R.id.my_dingdan_goods_color_noreceive);
            mViewHolder.tv_my_dingdan_goods_price = (TextView) convertView.findViewById(R.id.my_dingdan_goods_price_noreceive);
            mViewHolder.tv_my_dingdan_goods_num = (TextView) convertView.findViewById(R.id.my_dingdan_goods_num_noreceive);
            mViewHolder.tv_my_dingdan_goods_allprice = (TextView) convertView.findViewById(R.id.my_dingdan_goods_allprice_noreceive);
            mViewHolder.tv_my_dingdan_goods_allnum = (TextView) convertView.findViewById(R.id.my_dingdan_goods_num_all_noreceive);

            mViewHolder.btn_wuliu= (Button) convertView.findViewById(R.id.btn_chakanwuliu_noreceive);
            mViewHolder.more = (TextView) convertView.findViewById(R.id.fragment_my_dingdan_item_more_noreceive);
            mViewHolder.bill = (TextView) convertView.findViewById(R.id.fragment_my_dingdan_item_bill_noreceive);
            convertView.setTag(mViewHolder);
        } else {
            mViewHolder = (MyNoReceiveAdapter.ViewHolder) convertView.getTag();
        }
