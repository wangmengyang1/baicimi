...
package com.baicimi.zxing.view;
...
public final class ViewfinderView extends View {
	private static final int lanse =0xFF73D2F9;
...
//			canvas.drawText(getResources().getString(R.string.scan_text), frame.left, (float) (frame.bottom
