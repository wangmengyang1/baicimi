 ...
 * 物流信息View
 */
public class WuliuViewtow extends View {
    ...
    public WuliuViewtow(Context context) {
        super(context);
        init();
    }

    public WuliuViewtow(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WuliuViewtow(Context context, AttributeSet attrs, int defStyleAttr) {
