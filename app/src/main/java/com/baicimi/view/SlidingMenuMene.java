...
public class SlidingMenuMene extends RelativeLayout {
	...
	public SlidingMenuMene(Context context) {
		super(context);
	}

	public SlidingMenuMene(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SlidingMenuMene(Context context, AttributeSet attrs, int defStyle) {
