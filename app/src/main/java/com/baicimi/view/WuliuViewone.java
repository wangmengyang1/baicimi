 ...
 * 物流信息View   【广州市】已签收，签收是本人，感谢使用申通快递，期待再次为您服务
 */
public class WuliuViewone extends View {
    ...
    public WuliuViewone(Context context) {
        super(context);
        init();
    }

    public WuliuViewone(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WuliuViewone(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mMsg = "【广州市】广东太和公司派件员:冯浩洲   13246888312正在为你派件";
