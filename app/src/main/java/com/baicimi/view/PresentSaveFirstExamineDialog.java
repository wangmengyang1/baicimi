...
public class PresentSaveFirstExamineDialog extends Dialog {
    public PresentSaveFirstExamineDialog(Context context) {
        super(context);
    }

    public PresentSaveFirstExamineDialog(Context context, int themeResId) {
    ...
    public PresentSaveFirstExamineDialog(Context context, int themeResId , BaseFragment baseFragment ) {
        super(context, themeResId);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.present_save_first_examine_dialog);

        dissmess = (TextView) findViewById(R.id.present_save_first_examine_dialog_true);//延长存期
        ...
        deny = (TextView) findViewById(R.id.present_save_first_examine_dialog_false);//领取
