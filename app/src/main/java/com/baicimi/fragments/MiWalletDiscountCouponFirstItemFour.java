 ...
 */
public class MiWalletDiscountCouponFirstItemFour extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        particulars = (TextView) view.findViewById(R.id.miwalldt_discount_coupon_firstitme_four_particulars);
        layout_06 = (LinearLayout) view.findViewById(R.id.miwalldt_discount_coupon_firstitme_four_layout_06);
        particulars.setOnClickListener(this);
        layout_06.setOnClickListener(this);

        giventoone = (TextView) view.findViewById(R.id.miwalldt_discount_coupon_firstitme_four_giventoone);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.miwalldt_discount_coupon_firstitme_four_particulars:
                //了解详情
                if (!isLyoutVisible){
                ...
                break;
            case R.id.miwalldt_discount_coupon_firstitme_four_giventoone:
                //转赠
