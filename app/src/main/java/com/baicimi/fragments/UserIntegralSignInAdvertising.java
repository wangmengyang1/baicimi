 ...
 * 个人中心首页fragment 广告所得
 */
public class UserIntegralSignInAdvertising extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.user_integral_sign_in_advertising , container , false);


        expandableListView = (CustomExpandableListView)view.findViewById(R.id.user_integral_sign_in_advertising_exp_listview);
        LoadListData();
        ...
        back = (ImageView) view.findViewById(R.id.user_integral_sign_in_advertising_back);
    ...
    private void LoadListData() {
        ...
        GroupData.add(new UserIntegralSignInRecommendEntry("2017.08.25" , "宁菲"));
        GroupData.add(new UserIntegralSignInRecommendEntry("2017.08.25" , "宁菲"));
        GroupData.add(new UserIntegralSignInRecommendEntry("2017.08.25" , "七月菊"));
        GroupData.add(new UserIntegralSignInRecommendEntry("2017.08.25" , "七月菊"));
        GroupData.add(new UserIntegralSignInRecommendEntry("2017.08.25" , "品驰"));


        List<View> list_child1 = new ArrayList<>();
        list_child1.add(LayoutInflater.from(getContext()).inflate(R.layout.user_integral_sign_in_advertising_child_firat , null));
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.user_integral_sign_in_advertising_back:
    ...
    private class ExpandableAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            if (convertView == null){
                ...
                holder = new ExpandableAdapter.GetChildViewHolder();
