...
public class AfterSaleServerNumberSubmitFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        back = (ImageView) view.findViewById(R.id.after_sale_server_number_sbumit_back);
        back.setOnClickListener(this);

        submit_tv = (TextView) view.findViewById(R.id.after_sale_server_number_sbumit_submit);
    ...
    private void initListView() {
        listView = (ListView) view.findViewById(R.id.after_sale_server_number_sbumit_listview);
        list.clear();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.after_sale_server_number_sbumit_back:
                ((MainActivity)getActivity()).goBack();//返回到上一级界面
                break;
            case R.id.after_sale_server_number_sbumit_submit:
                startFragment(new AfterSaleServerSucceedFargment());//最终退货成功页面
                break;
        }
    }
}
