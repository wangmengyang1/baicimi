    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        if (typeS.equals("无参数")){
            ...
            if (typeS.equals("分期订单")){
                pay_way = (TextView) view.findViewById(R.id.order_form_fragment_readly_pay_way);
                pay_way.setText("分期支付");
                layout_02 = (LinearLayout) view.findViewById(R.id.order_form_fragment_layout_02);
                layout_02.setVisibility(View.VISIBLE);
            }else if (typeS.equals("我的预售订单")){
                layout_03 = (LinearLayout) view.findViewById(R.id.order_form_fragment_layout_03);
