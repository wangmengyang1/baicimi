...
public class HomeBrandConvertion extends BaseFragment {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.home_brand_convertion , container , false);
    ...
    private void initListView() {
        ...
        list.add(new EverydayConversionEntry("10月七日 7:00" , "20天17小时5分钟" , R.drawable.home_integer_conversion_01 , "香奈儿NO5香水" , "市场价：¥216.00"  , "积分：6556" , "数量：16556"));
        list.add(new EverydayConversionEntry("10月七日 7:00" , "20天17小时5分钟" , R.drawable.home_integer_conversion_01 , "香奈儿NO5香水" , "市场价：¥216.00"  , "积分：6556" , "数量：16556"));
        list.add(new EverydayConversionEntry("10月七日 7:00" , "兑换结束" , R.drawable.home_integer_conversion_01 , "香奈儿NO5香水" , "市场价：¥216.00"  , "积分：6556" , "数量：16556"));
