 ...
 * 个人中心   资产中心  幂钱包   我的收支记录
 */
public class MiWalletHomePageRecord extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.mi_wallet_homepage_record , container , false);
        back = (ImageView) view.findViewById(R.id.mi_wallet_homepage_record_back);
    ...
    private void initListView() {
        listView = (ListView) view.findViewById(R.id.mi_wallet_homepage_record_liatview);
        list.clear();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.mi_wallet_homepage_record_back:
