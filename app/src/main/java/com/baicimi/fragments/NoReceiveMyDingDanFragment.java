...
import com.baicimi.adapter.MyNoReceiveAdapter;
 ...
 * 未收货订单
 */
public class NoReceiveMyDingDanFragment extends BaseFragment{
    private MyListView mList;
    private ArrayList<MyDingDanLvBean> arrayList;
//    private MyDingDanListAdapter myListAdapter;
    private MyNoReceiveAdapter myListAdapter;
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        myListAdapter=new MyNoReceiveAdapter(getActivity(),arrayList);
