...
public class HomeIntegerHotBrandFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        back = (ImageView) view.findViewById(R.id.home_integer_hot_brand_fragment_back);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.home_integer_hot_brand_fragment_back:
