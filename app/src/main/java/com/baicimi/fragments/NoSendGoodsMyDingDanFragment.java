...
import com.baicimi.adapter.MyDingDanNoShipmentsAdapter;
 ...
 * 未发货订单
 */
public class NoSendGoodsMyDingDanFragment extends BaseFragment{
    private MyListView mList;
    private ArrayList<MyDingDanLvBean> arrayList;
    private MyDingDanNoShipmentsAdapter myListAdapter;
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        myListAdapter=new MyDingDanNoShipmentsAdapter(getActivity(),arrayList);
