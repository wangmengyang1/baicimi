 ...
 * 积分商城  兑换排行 限时兑换 兑换规则
 */
public class ConversionRuleFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.conversion_rule_fragment , container , false);
