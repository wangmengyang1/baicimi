 ...
 * 我的全部订单
 */
public class AllMyDingDanFragment extends BaseFragment{
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        for (int i=0;i<5;i++){
            myDingdanListBean_list.setTv_my_dingdan_goods_message("七月菊洗发水");
        ...
        myListAdapter=new MyDingDanListAdapter(getActivity(),arrayList);
...
//            @Override
//            public void run() {
//                System.out.println(view.getHeight() + "(((((((((((((((((((((我的高度");
//            }
//        });
        return view;
    }
