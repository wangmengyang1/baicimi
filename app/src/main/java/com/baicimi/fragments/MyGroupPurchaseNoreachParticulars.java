 ...
 * 我的团购未成团详情
 */
public class MyGroupPurchaseNoreachParticulars extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.my_group_purchase_noreach_particulars , container , false);
        //listview头部布局填充
        initListView();
        ...
        back = (ImageView) view.findViewById(R.id.my_group_purchase_noreach_back);
        back.setOnClickListener(this);
        return view;
    }
    //listview底部布局填充
    private void initListviewButtom() {
        secondLV = (ListView) view.findViewById(R.id.my_group_purchase_noreach_particulars_listview_second);
        listLV.clear();
    ...
    private void initListView() {
        listView = (ListView) view.findViewById(R.id.my_group_purchase_noreach_listview);
        list.clear();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.my_group_purchase_noreach_back:
