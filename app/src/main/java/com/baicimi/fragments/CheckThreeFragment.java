...
public class CheckThreeFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.check_three_item, container, false);
...
//        initBannerHead();
        ...
        packages = (ImageView) view.findViewById(R.id.img_gouwuche3);
        ...
        shopPackageNumber = (TextView) view.findViewById(R.id.img_gouwuche1_item_03);
    ...
    private void initVerticalViewPager() {
        verticalViewPager = (VerticalViewPager)view.findViewById(R.id.check_one_item_viewpager_03);
        list_vp.clear();
        for (int i = 0 ; i < 30 ; i++){
            list_vp.add(LayoutInflater.from(getContext()).inflate(R.layout.viewpager_item_03 , null));
        }
