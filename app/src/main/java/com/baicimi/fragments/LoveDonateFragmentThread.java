 ...
 * 个人中心首页 爱心捐赠   已完成资助
 */
public class LoveDonateFragmentThread extends BaseFragment{
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.love_donate_fragment_thread , container , false);
    ...
    private void initListView() {
        listView = (ListView) view.findViewById(R.id.love_donate_fragment_thread_listview);
        list.clear();
        list.add(1);
        list.add(1);
        list.add(1);
