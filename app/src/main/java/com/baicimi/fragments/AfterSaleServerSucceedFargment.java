...
public class AfterSaleServerSucceedFargment extends BaseFragment implements View.OnClickListener {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.after_sale_server_succeed_fragment , container , false);

        //listview布局填充
        initListView();

        back = (ImageView) view.findViewById(R.id.after_sale_server_succeed_back);
    ...
    private void initListView() {
        listView = (ListView) view.findViewById(R.id.after_sale_server_succeed_listview);
        list.clear();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.after_sale_server_succeed_back:
