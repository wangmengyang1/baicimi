 ...
 */
public class DistributorPurchaseOption extends BaseFragment implements View.OnClickListener {
    ...
    private TextView daychemical , beautymakeup , personalbelongings , motherandbaby;



    @Override
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.distributor_putchase_option , container , false);
        ...
        back = (ImageView) view.findViewById(R.id.back_distributor_putchase_option);
    ...
    private void initHeadTextViewBar() {
        daychemical = (TextView) view.findViewById(R.id.distributor_putchase_option_daychemical);
        beautymakeup = (TextView) view.findViewById(R.id.distributor_putchase_option_beautymakeup);
        personalbelongings = (TextView) view.findViewById(R.id.distributor_putchase_option_personalbelongings);
        motherandbaby = (TextView) view.findViewById(R.id.distributor_putchase_option_motherandbaby);
        daychemical.setOnClickListener(this);
        beautymakeup.setOnClickListener(this);
        personalbelongings.setOnClickListener(this);
        motherandbaby.setOnClickListener(this);
    }

    private void initTextViewSetColor(){
        daychemical.setTextColor(Color.BLACK);
        beautymakeup.setTextColor(Color.BLACK);
        personalbelongings.setTextColor(Color.BLACK);
        motherandbaby.setTextColor(Color.BLACK);
    }
    ...
    private void initGridView() {
        gridView = (GridView) view.findViewById(R.id.distributor_putchase_option_gridview);
        list = new ArrayList<>();
...
//        images.add(R.mipmap.new_ningfei_4);
        ...
        //头部轮播图片
        Banner banner = (Banner)view.findViewById(R.id.distributor_putchase_option_banner);
        //设置banner样式
...
//        listFragment.add(new TodayCosmeticsFragment());
        ...
        if (index > listFragment.size()){
            ...
            if(listFragment.get(index) == null){
                ...
                if(listFragment.get(index).isAdded()){
                    ...
                    //如果没有添加，则添加之后显示
                    fragmentTransaction.add(R.id.distributor_putchase_option_framelayout , listFragment.get(index) , tag).show(listFragment.get(index));
                }
                showIndex = index;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.back_distributor_putchase_option:
