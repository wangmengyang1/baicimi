...
public class LookLogisticsFragmentThread extends BaseFragment implements View.OnClickListener {
    ...
    private void initShow() {
        ...
        checkbox_01 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_01);
        checkbox_02 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_02);
        checkbox_03 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_03);
        checkbox_04 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_04);
        checkbox_05 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_05);
        checkbox_06 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_06);
        checkbox_07 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_07);
        checkbox_08 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_08);
        checkbox_09 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_09);
        checkbox_10 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_10);
        checkbox_11 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_11);
        checkbox_12 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_12);
        checkbox_13 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_13);
        checkbox_14 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_14);
        checkbox_15 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_15);
        checkbox_16 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_16);
        checkbox_17 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_17);
        checkbox_18 = (CheckBox) view.findViewById(R.id.lood_logistics_fragment_thread_checkbox_18);
...
//        layout_18.setBackgroundResource(R.drawable.look_logistics_fragment_second_layout_checkde_off_shape_05);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.lood_logistics_fragment_thread_checkbox_01:
                showFirst();
                checkbox_01.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_02:
                showFirst();
                checkbox_02.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_03:
                showFirst();
                checkbox_03.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_04:
                showFirst();
                checkbox_04.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_05:
                showSecond();
                checkbox_05.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_06:
                showSecond();
                checkbox_06.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_07:
                showSecond();
                checkbox_07.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_08:
                showThread();
                checkbox_08.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_09:
                showThread();
                checkbox_09.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_10:
                showThread();
                checkbox_10.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_11:
                showThread();
                checkbox_11.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_12:
                showFour();
                checkbox_12.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_13:
                showFour();
                checkbox_13.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_14:
                showFour();
                checkbox_14.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_15:
                showFive();
                checkbox_15.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_16:
                showFive();
                checkbox_16.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_17:
                showFive();
                checkbox_17.setChecked(true);
                break;
            case R.id.lood_logistics_fragment_thread_checkbox_18:
                showFive();
                checkbox_18.setChecked(true);
                break;
