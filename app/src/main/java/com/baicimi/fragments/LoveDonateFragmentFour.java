 ...
 * 个人中心首页 爱心捐赠   资助审核中
 */
public class LoveDonateFragmentFour extends BaseFragment{
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.love_donate_fragment_four , container , false);
    ...
    private void initGridView() {
        gridView = (GridView) view.findViewById(R.id.love_donate_fragment_four_gridview);
        listSecond.clear();
    ...
    private void initListView() {
        listView = (ListView) view.findViewById(R.id.love_donate_fragment_four_listview);
        list.clear();
