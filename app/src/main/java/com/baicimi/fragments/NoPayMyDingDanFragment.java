...
import com.baicimi.adapter.MyDingDanNoPaymentAdapter;
 ...
 * 我的订单页面 未付款订单
 */
public class NoPayMyDingDanFragment extends BaseFragment{
    private MyListView mList;
    private ArrayList<MyDingDanLvBean> arrayList;
//    private MyDingDanListAdapter myListAdapter;

    private MyDingDanNoPaymentAdapter myListAdapter;
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        myListAdapter=new MyDingDanNoPaymentAdapter(getActivity(),arrayList);
