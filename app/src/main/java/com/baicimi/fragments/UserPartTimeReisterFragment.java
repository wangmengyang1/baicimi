 ...
 *
 */
public class UserPartTimeReisterFragment extends BaseFragment implements View.OnClickListener {
...
//                    Toast.makeText(JsonDateActivity.this,"Parse Failed",Toast.LENGTH_SHORT).show();
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.user_part_time_rester_fragment , container , false);


        spinner = (LinearLayout) view.findViewById(R.id.user_part_time_rester_fragment_spinner);
        spinner_tv = (TextView) view.findViewById(R.id.user_part_time_rester_fragment_tv);
        ...
        spinner_02 = (Spinner) view.findViewById(R.id.user_part_time_rester_fragment_02);
        initSpinnerSecond(spinner_02);


        licenseTv = (TextView) view.findViewById(R.id.user_part_time_rester_fragment_license);
        licenseTv.setOnClickListener(this);

        addLayout = (TextView) view.findViewById(R.id.user_part_time_rester_fragment_addlayout);
        addLayout.setOnClickListener(this);

        layout = (LinearLayout) view.findViewById(R.id.user_part_time_rester_fragment_layout);


        back = (ImageView) view.findViewById(R.id.user_part_time_rester_fragment_option);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.user_part_time_rester_fragment_license:
                licenseTv.setText("图片");
                licenseTv.setPadding(12 , 12 , 12 , 12);
                break;
            case R.id.user_part_time_rester_fragment_addlayout:
                addLayout.setText("图片");
                addLayout.setPadding(12 , 12 , 12 , 12);
                layout.setVisibility(View.VISIBLE);
                break;
            case R.id.user_part_time_rester_fragment_option:
